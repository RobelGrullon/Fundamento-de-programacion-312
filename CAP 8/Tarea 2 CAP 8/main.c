...
/* Estructuras-2.
El programa muestra la menra en que se declara una estructura, asi como la
...
rebibe como parametro un apuntador de tipo estructura. */
...
a3 = &a0;         /* En este caso el apuntador de tipo estructura de alumno a3
...
a5 = &a0;
Lectura(a5);   /* EN este caso se pasa al apuntador de tipo estructura alumno
...
printf("%d\t%s\t%s\t%.2f\t%s", a3->nombre, a3->carrera,
       ...
       printf("\nDatos del alumno 5\n");
       printf("%d\t%s\t%s\t%s\t%s", a5-matricula, a5->nombre, a5->carrera,
