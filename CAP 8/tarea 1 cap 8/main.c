...
/* Estructuras -1.
El programa muesta la manera en que se declara una estructura, asi como la
forma en que se tiene acceso a los campos de las variables de tipo estructura
tanto para la asignacion de valores como para lectura y escritura. */

struct alumno                         /* Declaracion de la estructura. */
{
    int matricula;
    char nombre[20];
    char carrera[20];                  /* Campo de la estructura. */
    float promedio;
    char direccion[20];
...
void main(void)
{
    ...
    /* Observa otra forma de escribir los campos de la vairable de tipo estructura
    a3. */
    printf("\nDatos del alumno 3\n");
