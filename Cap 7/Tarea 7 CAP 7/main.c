...
i = strlen(cad0);
/* La funcion strlen obtiene la longitud —el numero de caractres— de
una cadena. */
...
determinado caracteer en la cadena de caracteres. Si lo encuentra regresa
unapuntador a la primera ocurrencia del caracter ene la cadena, de otra
forma regresa NULL. */
if  (c != NULL)
{
