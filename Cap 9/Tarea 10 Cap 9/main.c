...
/* Alumnos.
El programa pregunta al usuario el numero de resgistro que desea
modificar, obtiene el nuevo promedio del alumno y modifica tantl el
...
El segundo se;ala el numero de bloques que debe moverse, en terminos
